...
Try {
	...
	[string]$appName = 'Desktop Public Edition'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		## <Perform Installation tasks here>
			...
			$exitCode = Execute-Process -Path "$dirFiles\TableauPublicDesktop-64bit-2022-2-0.exe" -Parameters "ACCEPTEULA=1 AUTOUPDATE=1 DATABASEDRIVERS=1 DESKTOPSHORTCUT=1 REMOVEINSTALLEDAPP=1 /quiet /norestart" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$dirFiles\TableauPublicDesktop-64bit-2022-2-0.exe" -Parameters "/uninstall /quiet" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
